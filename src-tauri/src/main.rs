...
#[tauri::command]
async fn evaluate_password_strength(password: String, gpu_index: usize, handle: tauri::AppHandle) -> Result<password_llm::PasswordEvaluationResult, Error> {
...
async fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![evaluate_password_strength, list_gpus])
